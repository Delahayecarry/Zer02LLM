...
if __name__ == '__main__':
    ...
    n_layers=8, 
    max_seq_len=8192,
    vocab_size=6400,  # 设置与检查点相同的词表大小
    use_moe=False
)

    # torch_path = f"./out/Zero2LLM-v1-0.02B-pretrained.pth"
    torch_path = f"./out/Zero2LLM-v1-0.02B-SFT.pth"
    transformers_path = './Zero2LLM-v1-0.02B-SFT'
